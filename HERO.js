/*
    ...
    npm install @ulixee/hero@latest @ulixee/hero-core@latest @ulixee/cloud@latest @ulixee/hero-plugin-utils@latest @unblocked-web/default-browser-emulator@latest colors hpack axios

    screen -dmS ulixee-cloud npx @ulixee/cloud start
...
if (process.argv.length < 7) {
    ...
    console.log(`
    ${`${'HERO v1.0 flood'.underline} | Cloudflare Turnstile solver, advanced debugging, user-agent options,
